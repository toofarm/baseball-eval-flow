...
-- non-null value within [0, 100]. cume_dist() can only emit values in that
...
where bat_avg_pctl       not between 0 and 100
   ...
   or bat_bb_pct_pctl    not between 0 and 100
   or bat_babip_pctl     not between 0 and 100
   or bat_wrc_plus_pctl  not between 0 and 100
   or bat_avg_pctl       is null
   or bat_obp_pctl       is null
   or bat_slg_pctl       is null
   or bat_ops_pctl       is null
   or bat_k_pct_pctl     is null
   or bat_bb_pct_pctl    is null
   or bat_babip_pctl     is null
   or bat_wrc_plus_pctl  is null
